...
export PIPELINE_RUN_NAME="V013_20260812_1280x800"
...
export PIPELINE_OUTPUT_DIR='["/data/users/hailong.he/nas_smb/Docs_Internal/知识库(钉钉同构)/算法工具链/算法应用（主）/应用场景/【舜宇】清洁机器人/DEMO开发/训练数据"]'
...
# 默认按 train、export、test、report 执行，不处理数据。也可传入单阶段命令.

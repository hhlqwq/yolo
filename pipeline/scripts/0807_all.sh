...
export PIPELINE_RUN_NAME="V011_20260807_add0730"
# 本批次原始 LabelMe 数据目录.数据处理只复制,不会移动或修改这里的文件.
export PIPELINE_INPUT_DIR='["/data/users/hailong.he/nas_smb/Docs_Internal/知识库(钉钉同构)/算法工具链/算法应用（主）/应用场景/【舜宇】清洁机器人/DEMO开发/数据采集/DATA/02_相似工业场景/【曹辉】【20260730】【楼下会议室】/img"]'
# 本批次标准数据集目录.首次运行生成,同名重跑严格校验后跳过处理.
export PIPELINE_OUTPUT_DIR='["/data/users/hailong.he/nas_smb/Docs_Internal/知识库(钉钉同构)/算法工具链/算法应用（主）/应用场景/【舜宇】清洁机器人/DEMO开发/数据采集/DATA/02_相似工业场景/【曹辉】【20260730】【楼下会议室】/train"]'
